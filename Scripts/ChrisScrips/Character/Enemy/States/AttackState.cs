    ...
    public class AttackState : State
    {
            ...
            if (currentAttack != null)
            {
                ...
                else if (distanceFromTarget < currentAttack.maximumDistanceNeededToAttack)
                {
                    if (viewableAngle <= currentAttack.maximumAttackAngle && viewableAngle >= currentAttack.minimumAttackAngle)
                    {
                        ...
                        {
                            enemyManager.enemyCombatManager.currentAttackType = currentAttack.attackType;
        ...
        private void GetNewAttack(EnemyManager enemyManager)
        {
            ...
            for (int i = 0; i < enemyAttacks.Length; i++)
            {
                ...
                {
                    enemyAttackAction.maximumDistanceNeededToAttack = 4.5f;
                    Debug.Log("Enemy Worm Attack Range: " + enemyAttackAction.maximumDistanceNeededToAttack);
