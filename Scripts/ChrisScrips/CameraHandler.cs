...
namespace FYP
{
    public class CameraHandler : PlayerSetupBehaviour
    {
        ...
        protected override void Awake()
        {
            ...
            if(playerManager){
                ...
                playerManager.cameraHandler = this;
            }
        ...
        public void HandleCameraRotation(float delta, float mouseXInput, float mouseYInput)
        {
            if (inputHandler.lockOnFlag == false && currentLockOnTarget == null)
            {
                ...
                myTransform.DOKill();
                myTransform.DORotateQuaternion(targetRotation, 0.15f);
                ...
                cameraPivotTransform.DOKill();
                cameraPivotTransform.DOLocalRotateQuaternion(targetRotation, 0.15f);
            }
            else
            {
                // float velocity = 0;
        ...
        public void HandleLockOn()
        {
            ...
            for (int i = 0; i < colliders.Length; i++)
            {
                ...
                if (character != null)
                {
                    ...
                    {
                        if (character.lockOnTransform == null)
                        {
                            continue;
                        }
        ...
        public void SetPlayerPref(){
            if (PlayerPrefs.HasKey("MouseSensitivity")){    
                ...
                PlayerPrefs.SetFloat("MouseSensitivity", lookSpeed);
                PlayerPrefs.Save();
            }
        }

        //Network Function
        public override void Setup(PlayerManager localPlayerManager){
            playerManager = localPlayerManager;
            targetTransform = localPlayerManager.transform;
            localPlayerManager.cameraHandler = this;
            inputHandler = localPlayerManager.GetComponent<InputHandler>();
        }
